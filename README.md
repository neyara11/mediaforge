...
- **Music Studio** — генерация музыки двумя провайдерами:
  ...
  - **ACE-Step 1.5** (локальный сервер) — text2music, cover, repaint, извлечение стемов (extract), догенерация аранжировки (complete); AI-планировщик промптов переводит описание на английский и заполняет BPM/тональность/размер
